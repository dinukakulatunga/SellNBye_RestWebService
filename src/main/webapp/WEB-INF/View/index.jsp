		...
		<nav class="main-navbar">
			<div class="container">
				...
				<ul class="main-menu">
					...
					<li><a href="#">Cellphones and Accessories
...
<!-- Hero section -->
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			...
			<div class="hs-item set-bg" data-setbg="static/img/bg-2.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-white">
							<span>New Arrivals</span>
		...
		<div class="container">
			...
			<div class="product-slider owl-carousel">
				...
				<div class="product-item">
					<div class="pi-pic">
						<img src="static/img/7c67a52e-061a-49b3-a1de-827e1efc5bf3.jpg" alt="">
						<div class="pi-links">
	...
	<section class="banner-section">
		<div class="container">
			<div class="banner set-bg" data-setbg="static/img/banner-bg.jpg">
				...
				<a href="category.html" class="site-btn">Category</a>
			</div>
		</div>
	</section>
	<!-- Banner section end  -->
	...
	<section class="footer-section">
		<div class="container">
			<div class="footer-logo text-center">
				<a href="index.html"><img src="static/img/sellnbyeLogo.png" alt=""></a>
			</div>
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6">
					<div class="footer-widget about-widget">
						...
						<div class="fw-latest-post-widget">
							<div class="lp-item">
								<div class="lp-thumb set-bg" data-setbg="static/img/blog-thumbs/1.jpg"></div>
							...
							<div class="lp-item">
								<div class="lp-thumb set-bg" data-setbg="static/img/blog-thumbs/2.jpg"></div>
								<div class="lp-content">
...
<p class="text-white text-center mt-5">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Dinuka</a></p>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
