                        ...
                        <!--<div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="password" name="password" value="${supplier.password}" id="password">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Confirm Password</label>
                                    <input class="input--style-4" type="text" name="confpw" id="confpw">
                                </div>
                            </div>
                        </div>-->
                        <div class="p-t-15">
                        <!--<input type="submit" class="btn btn--radius-2 btn--blue" value="Register" onclick="return validateForm();"/>-->
                           <button type="submit" class="btn btn--radius-2 btn--blue" onclick="return validateForm();">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
